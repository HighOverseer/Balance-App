...
class _RegistrationState extends State<RegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    return MyHomePage(SingleChildScrollView(
      ...
      child: Column(
        children: [
                  ...
                  child: Row(
                    children: [
                      SizedBox(
                        width: 16,
                        height: 16,
                        child: Image.asset("assets/image/ic_button_back.png"),
                      ),
                      SizedBox(
                        width: 8,
                      ),
          ...
          Container(
            padding: EdgeInsets.only(left: 36, right: 36, top: 24, bottom: 84),
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () => showDialog(
                              ...
                              builder: (BuildContext context) {
                                return FilePickerDialog(fileUri: _fileUri, (newFileUri) {
                                  setState(() {
                                    _fileUri = newFileUri;
                                  });
                                });
                  ...
                  onPressed: () {
                    showDialog(
                      ...
                      Future.delayed(
                        Duration(seconds: 1),
                        (){
                          Navigator.popUntil(context, ModalRoute.withName(MainRoutes.login.path));
