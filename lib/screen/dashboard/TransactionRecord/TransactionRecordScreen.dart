...
enum TransactionRecordRoutes { list, add }
              ...
              : TransactionRecordAddFragment(
                ...
                (transactionRecord, isNew) {
                  if (isNew) {
                    ...
                    int itemIndex = _transactionRecords.indexWhere(
                      (item) => item.id == transactionRecord.id,
                    );
                    _transactionRecords.replaceRange(itemIndex, itemIndex + 1, [
                      transactionRecord,
                    ]);
                  }
                  navigateToList();
